...
private String INPUTFILE = "/Users/J.Mollemans/Desktop/registraties.xml";
	...
	/** Get the race with reg_id and return them 
	 * in html format
	 */
	public String getRace(String reg_id) {
		File inputFile = new File(INPUTFILE);
        DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
        DocumentBuilder dBuilder;
	...
	/** Delete the rqce with reg_id and return all races in 
	 * valid format
	 */
	public String deleteRace(String reg_id) {
		File inputFile = new File(INPUTFILE);
        DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
        DocumentBuilder dBuilder;
	...
	/**
	 * Add a runner to race with reg_id and 
	 * return all races in html format
	 */
	public String addRunner(String reg_id, String xml) {
